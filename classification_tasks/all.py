...
gt_thesh = find_threshold_density(
    np.log10(ground_truth_data[mask]), where_chaos="higher"
)
...
for t, data in zip(times, lyapunov_data):
    ...
    lyapunov_thresholds.append(find_threshold_density(data[mask], where_chaos="higher"))
...
for t, data in zip(times, megno_data):
    ...
    megno_thresholds.append(find_threshold_density(data[mask], where_chaos="higher"))
...
for t, data in zip(times, fli_x_data):
    ...
    fli_x_thresholds.append(find_threshold_density(data[mask], where_chaos="higher"))
...
for t, data in zip(times, gali_data):
    ...
    gali_thresholds.append(find_threshold_density(data[mask], where_chaos="lower"))
...
for t, data in zip(times_fma, fma_fft_data):
    ...
    fma_fft_thresholds.append(find_threshold_density(data[mask], where_chaos="higher"))
...
for t, data in zip(times_fma, fma_birkhoff_data):
    ...
    fma_birkhoff_thresholds.append(
        find_threshold_density(data[mask], where_chaos="higher")
    )
...
for t, data in zip(times, rem_data):
    ...
    rem_thresholds.append(find_threshold_density(data[mask], where_chaos="higher"))
